    ...
    <section className="w-full py-12 sm:py-16 px-4 sm:px-6 bg-white flex flex-col items-center">
      <div className="max-w-2xl mx-auto text-center">
        <div className="italic text-base sm:text-lg text-[#0D5392] mb-6 leading-relaxed">
          &ldquo;Being a part of the Global Shapers Community has transformed my perspective on leadership and collaboration. Together, we are making a tangible impact on our communities and beyond.&rdquo;
        </div>
